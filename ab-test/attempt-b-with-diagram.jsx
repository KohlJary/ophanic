  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex">
        ...
        <aside className="
          hidden md:flex md:flex-col md:w-[20%] lg:w-[20%]
          bg-white min-h-[calc(100vh-4rem)] p-4 shadow-sm
        ">
          {/* Desktop: full text */}
        ...
        <main className="flex-1 p-6">
          {/* Metric Cards Row - 3 equal columns */}
          <div className="
      ...
      <nav className="
        ...
        bg-white border-t flex justify-around py-3
      ">
        <span className="text-xl">📊</span>
        <span className="text-xl">📈</span>
        <span className="text-xl">📋</span>
...
// │     │  │ ↑ +12%           │
// └─────┘  └──────────────────┘
// Icon block vertically centered against text block
...
// │ ◯  Sarah updated prof    5m ago │
// │ ◯  Mike left comment    12m ago │
// └─────────────────────────────────┘
    ...
    <div className="bg-white rounded-lg shadow-sm">
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-7 gap-1 text-center text-sm">
          {/* Leading blanks */}
          {[...Array(blanks)].map((_, i) => <div key={`b${i}`}></div>)}
